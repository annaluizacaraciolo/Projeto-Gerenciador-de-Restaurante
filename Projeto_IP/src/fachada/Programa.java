			...
			for (; sessao == true;) {
				...
				if (comando.equals("1")) {
                    ...
                    try {
					    ...
					    Mesa mesa;
						try {
							mesa = fachada.procurarMesa(identificadorMesa);
							try {
						    	Pedidos pedido = mesa.getPedidos().procurar(identificadorPedido);
						    	fachada.cancelarPedido(pedido, mesa);
						    	System.out.println("Pedido cancelado com sucesso!");
						    } catch (PedidoNaoCadastradoException e) {
						    	System.out.println(e);
						    }
						} catch (MesaNaoCadastradaException e1) {
							e1.printStackTrace();
						}
					...
					if (operacao.equals("1")) {
                        					...
                        					System.out.println ("Qual o numero da mesa que voce quer cadastrar?");
                    ...
                    //CADASTRO         	
					if (operacao.equals("1")) {
						System.out.println("Voc� escolheu a opcao cadastrar funcionario");
                                          	//INFORMACOES
